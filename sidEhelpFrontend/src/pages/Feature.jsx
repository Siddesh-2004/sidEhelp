            ...
            <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
              <div className="flex flex-col gap-10 px-4 py-10 @container">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-3 pb-3 border-2 border-orange-300 rounded-xl p-6 bg-gradient-to-br from-gray-900 via-blue-900 to-black shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 hover:border-orange-400 group h-full">
                    <div
                    ...
                    />
                    <div className="bg-gradient-to-r from-orange-950/80 via-red-950/70 to-gray-900 p-4 rounded-lg border border-orange-600/50 backdrop-blur-sm flex flex-col flex-1">
          ...
          >
            <button className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white text-sm font-semibold py-2 px-4 rounded-lg transition-all duration-200 hover:shadow-lg transform hover:scale-105 border border-orange-400">
              Try Now
                  ...
                  <div className="flex flex-col gap-3 pb-3 border-2 border-blue-300 rounded-xl p-6 bg-gradient-to-br from-gray-900 via-blue-900 to-black shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 hover:border-blue-400 group h-full">
                    <div
                    ...
                    />
                    <div className="bg-gradient-to-r from-blue-950/80 via-indigo-950/70 to-gray-900 p-4 rounded-lg border border-blue-600/50 backdrop-blur-sm flex flex-col flex-1">
                  ...
                  {/* Search Library Card */}
                  <div className="flex flex-col gap-3 pb-3 border-2 border-emerald-300 rounded-xl p-6 bg-gradient-to-br from-gray-900 via-blue-900 to-black shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 hover:border-emerald-400 group h-full">
                    <div
                    ...
                    />
                    <div className="bg-gradient-to-r from-emerald-950/80 via-green-950/70 to-gray-900 p-4 rounded-lg border border-emerald-600/50 backdrop-blur-sm flex flex-col flex-1">
                  ...
                  {/* Study Planner Card */}
                  <div className="flex flex-col gap-3 pb-3 border-2 border-purple-300 rounded-xl p-6 bg-gradient-to-br from-gray-900 via-blue-900 to-black shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 hover:border-purple-400 group h-full">
                    <div
                    ...
                    />
                    <div className="bg-gradient-to-r from-purple-950/80 via-indigo-950/70 to-gray-900 p-4 rounded-lg border border-purple-600/50 backdrop-blur-sm flex flex-col flex-1">
